...
## Summary
If the purpose of assessing credit risk was to reduce defaults, then we want a more precise algorithm, especially for high risk applicants. The reasmpling methods generally had lower precision and higher sensitivity than the ensemble classifiers. Therefore, I would recommend the ensemble classifiers to perform credit risk assessments rather than resamplers. Furthermore, additional data preprocessing could increase precision. 
